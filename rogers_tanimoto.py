...
class RogersTanimoto(BaseComparisons):
    """Class to calculate the Rogers-Tanimoto index.
    ...
    def rt_1sim_wdis(self):
        ...
        denominator = self.w_p + self.total_w_dis
        self.RT_1sim_wdis = numerator/denominator

    def rt_1sim_dis(self):
        """Calculate the index with 1-sim-counters and with unweighted denominator.
        ...
        """
        numerator = self.total_w_sim
        denominator = self.p + self.total_dis
        self.RT_1sim_dis = numerator/denominator
