...
class SokalSneath1(BaseComparisons):
    """Class to calculate the Sokal-Sneath 1 index.
    ...
    def ss1_1sim_wdis(self):
        ...
        """
        numerator = self.w_a
        denominator = self.w_a + 2 * self.total_w_dis
        self.SS1_1sim_wdis = numerator/denominator

    def ss1_1sim_dis(self):
        """Calculate the index with 1-sim-counters and with unweighted denominator.
        ...
        """
        numerator = self.w_a
        denominator = self.a + 2 * self.total_dis
        self.SS1_1sim_dis = numerator/denominator
